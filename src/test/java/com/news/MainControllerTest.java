...
import com.news.controller.MainController;
...
@Sql(value = {"/create-user-before.sql", "/news-list-before.sql"}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
@Sql(value = {"/news-list-after.sql", "/create-user-after.sql"}, executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
...
public class MainControllerTest {
    ...
    public void filterMessageTest() throws Exception {
        this.mockMvc.perform(get("/main").param("filter", "my-title"))
                .andDo(print())
                .andExpect(authenticated())
